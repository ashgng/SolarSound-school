...
GRAY = (200, 200, 200)
PURPLE = (70, 50, 200)
LIGHT_PURPLE = (210, 180, 250)
BUTTON_COLOR = (100, 200, 100)
TEXT_COLOR = (255, 255, 255)
BG_COLOR = (30, 30, 30)

# Police d'écriture
title_font = pygame.font.SysFont('broadway', 100)
...
def run_loading_screen():
    ...
    while running:
        ...
        if fill_width < bar_width :
            fill_width = min(bar_width * (current_step / 6), fill_width + random.uniform(0,2))
    ...
    def run(self):
        ...
        while not selected_file:
            ...
            for idx, file in enumerate(file_list):
                ...
                pygame.draw.rect(screen, LIGHT_PURPLE, file_rect)
                pygame.draw.rect(screen, BLACK, file_rect, 2)
